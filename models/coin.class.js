...
class Coin extends DrawableObject {
    /** @type {HTMLAudioElement} Static sound object for collection sound */
    static collectSound = new Audio('sounds/coin_collect.mp3'); // Pfad zu deiner Sound-Datei
    ...
    static drawCounter(ctx, canvasWidth, collectedCoins) {
        ...
        ctx.fillText(collectedCoins.toString(), counterX + counterWidth - 25, counterY + counterHeight/2);
