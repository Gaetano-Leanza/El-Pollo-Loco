...
class CharacterHealth {
  ...
  hit() {
    ...
    if (currentTime - this.character.lastHit > this.character.timeToRecover) {
      ...
      console.log(`Character hit! Energy: ${this.character.energy}`); // Debug log
    }
  ...
  triggerDeath() {
    ...
    console.log("Character death triggered!"); // Debug log
  ...
  forceDamage(damage) {
    ...
    console.log(`Character force damaged! Energy: ${this.character.energy}`);
    this.checkForDeath();
  }
}